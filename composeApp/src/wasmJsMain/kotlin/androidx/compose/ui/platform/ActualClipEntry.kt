...
/**
 * Actual implementation of [ClipEntry] for Web (WasmJs).
 *
 * The constructor is called from common code. This class holds the data.
 * The actual interaction with the browser's clipboard API happens within the
...
actual class ClipEntry actual constructor(
    ...
    // No further WasmJs-specific implementation is needed within ClipEntry itself
